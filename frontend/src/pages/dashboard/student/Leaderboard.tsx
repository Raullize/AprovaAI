            ...
            <div className="mb-6 flex flex-col md:flex-row gap-4 items-center justify-between pb-6 border-b border-slate-100">
              ...
              <div className="relative w-full md:w-80">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 rounded-2xl border border-slate-200 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all bg-white text-slate-800 text-sm font-medium placeholder-slate-400 animate-fade-in"
                />
              </div>
