...
Embora organizado sob a estrutura de modulos do NestJS, o codigo original persistia com logicas misturadas no escopo do framework. Como simulado final de maturidade, o projeto abracou a **Arquitetura Limpa** unida ao **Domain-Driven Design**.
