...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      'fixed top-4 left-1/2 -translate-x-1/2 md:left-auto md:right-4 md:translate-x-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 md:max-w-[420px] gap-2',
      className,
    )}
    {...props}
  />
