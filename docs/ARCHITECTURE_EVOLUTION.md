...
- **Mapeamento de Regras em BDD:** As regras do sistema saíram da abstração do código e foram documentadas no arquivo `BUSINESS_RULES.md` usando linguagem de produto (Dado-Quando-Então). Isso serve como contrato estrito para testes e como insumo para a banca do TCC.
