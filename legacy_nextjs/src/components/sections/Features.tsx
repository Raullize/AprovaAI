...
const features: Feature[] = [
  ...
  },
  {
    ...
    description: 'Explicações específicas para cada alternativa e links para aprofundamento, potencializando seu aprendizado.',
    icon: 'MessageSquare'
  },
  {
    id: '3',
    title: 'Gamificação Inteligente',
    description: 'Conquiste medalhas, mantenha streaks de estudo e acompanhe seu progresso com sistema de recompensas motivador.',
    icon: 'Trophy'
  },
  {
    id: '4',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Nossa metodologia única combina estrutura pedagógica, tecnologia avançada e gamificação 
            para maximizar seu potencial de aprovação.
          </p>
        </div>
        ...
        <div className="text-center mt-16">
          <div className="bg-gradient-to-r from-primary-600 to-purple-600 rounded-2xl p-8 text-white">
            ...
            <p className="text-lg opacity-90 mb-6">
              Junte-se a milhares de estudantes que já estão transformando seus resultados com o AprovaAI.
            </p>
